...
let parserWithMetadata = parser.configure({
  props: [
    styleTags({
      ...
      'in with apply type where': t.keyword,
      'not and or': t.logicOperator,
      PropertyName: t.propertyName,
      PathSep: t.punctuation,
      'ProtocolDeclaration/...': t.typeName,
      'ProtocolDeclaration/TypeParamList/TypeParam': t.typeOperator,
      'ProtocolMethodSignature/TypeParamList/TypeParam': t.typeOperator,
      'ImplBlock/...': t.typeName,
      'ImplBlock/TypeParamList/TypeParam': t.typeOperator,
      'ImplBlock/WhereClause/WherePredicate/identifier': t.typeName,
      'AssociatedTypeDeclaration/identifier': t.typeName,
      'AssociatedTypeBinding/identifier': t.typeName,
