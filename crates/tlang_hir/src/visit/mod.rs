...
///
/// ```rust
/// use tlang_hir::{PostOrderVisitor, hir};
/// use tlang_hir::visit::post_order_walk_expr;
///
...
/// }
/// ```
pub trait PostOrderVisitor<'hir>: Sized {
    // The default type here requires #![feature(associated_type_defaults)]
    type Context = ();
    ...
    fn visit_module(&mut self, module: &'hir mut hir::Module, ctx: &mut Self::Context) {
        post_order_walk_module(self, module, ctx);
    }

    fn visit_block(&mut self, block: &'hir mut hir::Block, ctx: &mut Self::Context) {
        post_order_walk_block(self, block, ctx);
    }

    fn visit_stmt(&mut self, stmt: &'hir mut hir::Stmt, ctx: &mut Self::Context) {
        post_order_walk_stmt(self, stmt, ctx);
    }
    ...
    fn visit_pat(&mut self, pat: &'hir mut hir::Pat, ctx: &mut Self::Context) {
        post_order_walk_pat(self, pat, ctx);
    }
...
/// Post-order walk functions that traverse children before visiting the current node
pub fn post_order_walk_module<'hir, V: PostOrderVisitor<'hir>>(
    visitor: &mut V,
    module: &'hir mut hir::Module,
    ctx: &mut V::Context,
) {
...
pub fn post_order_walk_block<'hir, V: PostOrderVisitor<'hir>>(
    visitor: &mut V,
    block: &'hir mut hir::Block,
    ctx: &mut V::Context,
) {
...
pub fn post_order_walk_stmt<'hir, V: PostOrderVisitor<'hir>>(
    visitor: &mut V,
    stmt: &'hir mut hir::Stmt,
    ctx: &mut V::Context,
) {
...
pub fn post_order_walk_expr<'hir, V: PostOrderVisitor<'hir>>(
    visitor: &mut V,
    expr: &'hir mut hir::Expr,
    ctx: &mut V::Context,
) {
...
pub fn post_order_walk_pat<'hir, V: PostOrderVisitor<'hir>>(
    visitor: &mut V,
    pat: &'hir mut hir::Pat,
    ctx: &mut V::Context,
) {
