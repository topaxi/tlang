...
3. **Assume handwritten code**: Any HIR structure that could be generated by lowering could also be handwritten by a developer. Your transformation logic must handle both cases identically.
